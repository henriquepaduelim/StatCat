  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-48 -left-36 h-[30rem] w-[30rem] rounded-full bg-[rgba(51,153,137,0.45)] blur-[150px]" />
        <div className="absolute top-[-12%] right-[-20%] h-[28rem] w-[28rem] rounded-full bg-[rgba(125,226,209,0.4)] blur-[180px]" />
        <div className="absolute bottom-[-34%] left-1/4 h-[30rem] w-[30rem] rounded-full bg-[rgba(51,153,137,0.35)] blur-[200px]" />
        <div className="absolute top-[35%] left-[8%] h-[18rem] w-[18rem] rounded-full bg-[rgba(43,44,40,0.25)] blur-[160px]" />
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[rgba(125,226,209,0.4)] to-transparent" />
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        {!isVideoReady && (
          <div className="absolute inset-0 flex items-center justify-center bg-surface/70 text-center text-xs text-muted backdrop-blur">
      ...
      <main className="mx-auto max-w-6xl space-y-24 px-6 pb-24 pt-16">
        <section className="grid gap-12 lg:grid-cols-[1.15fr,1fr] lg:items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/40 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-primary shadow-sm">
              {t.common.heroBadge}
            </div>
        ...
        <section id="features" className="space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {t.home.features.map((feature) => (
              ...
              >
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#339989]/18 via-[#7de2d1]/12 to-[#fffafb]/18 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                <h3 className="relative text-lg font-semibold text-on-surface">{feature.title}</h3>
