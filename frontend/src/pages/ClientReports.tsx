  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold text-on-surface">{client.name} — Reports</h1>
      ...
      <section className="space-y-4 rounded-xl bg-surface p-6 shadow-sm">
        <div>
          <p className="text-sm font-semibold text-on-surface">PDF exports</p>
          <p className="text-xs text-muted">Configure cover pages, language and delivery cadence.</p>
        </div>
        <div>
          <p className="text-sm font-semibold text-on-surface">Data warehouse</p>
