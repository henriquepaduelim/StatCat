...
def clean_placeholder_participants():
    ...
    with Session(engine) as session:
        ...
        for participant in placeholders:
            print(
                f"  - Event ID: {participant.event_id}, Athlete ID: {participant.athlete_id}, User ID: {participant.user_id}"
            )
        ...
        print(
            "Athletes will no longer appear as pending confirmations for admin users."
        )
